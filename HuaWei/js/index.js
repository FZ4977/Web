$(function(){
	...
	$("#nav a").hover(function(){
		...
		$(this).find(".leftF").hide();
		$(this).find(".rightF").show();
		
	},function(){
		$(this).find(".rightF").hide();
		$(this).find(".leftF").show();
	});
});
window.onload = function() {
			var div = document.getElementById('lunbo'); //通过id查找div
			...
			timer = setInterval(change, 2000); //启动一个定时器1000毫秒调用一次change函数（切换一张图片）
